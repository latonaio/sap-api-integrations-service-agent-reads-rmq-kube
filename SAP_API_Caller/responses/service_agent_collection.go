...
type ServiceAgentCollection struct {
	D struct {
		Results []struct {
			...
			ETag                              string `json:"ETag"`
			ServiceAgentAttachmentFolder      struct {
				Deferred struct {
					URI string `json:"uri"`
				} `json:"__deferred"`
			} `json:"ServiceAgentAttachmentFolder"`
			ServiceAgentOrganisationalUnitAssignment struct {
				Deferred struct {
					URI string `json:"uri"`
				} `json:"__deferred"`
			} `json:"ServiceAgentOrganisationalUnitAssignment"`
			ServiceAgentTextCollection struct {
				Deferred struct {
					URI string `json:"uri"`
				} `json:"__deferred"`
			} `json:"ServiceAgentTextCollection"`
		} `json:"results"`
	} `json:"d"`
}
